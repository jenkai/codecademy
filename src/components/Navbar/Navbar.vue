  ...
  <nav>
    <div class="nav-container">
      <div class="nav-left">
        ...
        <a href="/" class="nav-text"> <div>Catalog</div></a>
        <Dropdown :titles="resource" mainTitle="Resource" />
        <Dropdown :titles="community" mainTitle="Community" />
        <Dropdown :titles="proPricing" mainTitle="Pro Pricing" />
        <a href="/" class="nav-text"> <div>For business</div></a>
      </div>
      <div class="nav-right">
        <div class="zoom">
          <a href="/">
        ...
        <a href="/" class="nav-text" style="color:#3311c9; font-weight:bold;">
          <div>Log in</div></a
        >
      </div>
    </div>
